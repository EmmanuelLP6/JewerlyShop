...
if ( !function_exists('debug_console')) {
    function debug_console($data,$context = 'Debug in Console'){
...
if (! function_exists('debug')) {
    function debug($data, $die = true, $add_var_dump = false, $add_last_query = true)
    {
        $CI = &get_instance();
...
if (!function_exists('debug_echo')) {
    function debug_echo($var, $bgcolor='#3377CC', $custom_style='')
    {
...
// ------------------------------------------------------------------------
if (!function_exists('debug_terminal')) {
    function debug_terminal($var, $die=true)
    {
        $CI = &get_instance();
        $CI->load->library('unit_test');
        $bt = debug_backtrace();
