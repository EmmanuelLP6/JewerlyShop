<div class="row clearfix">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <center>
                    <img src="<?php echo base_url(($usuario->imagen_usuario != NULL ? 'uploads/users/'.$usuario->imagen_usuario : 'uploads/icons/user.jpg')); ?>" width="15%" id="preview" class="img-circle">
				</center><hr>
                <?php echo form_open_multipart('',['id'=>'usuario-detalles']); ?>
                    <div class="panel-body">
                        <input type="hidden" name="id_usuario" value="<?php echo $usuario->id_usuario ?>">
                        <input type="hidden" name="imagen-usuario-anterior" value="<?php echo $usuario->imagen_usuario ?>">
                        <div class="row clearfix">
                            <div class="col-md-4">
                                <div class="form-group form-float">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line" id="nombre_has_error">
                                            <input type="text" class="form-control date" placeholder="Nombre(s)" name="nombre_usuario" value="<?php echo $usuario->nombre_usuario; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line" id="ap_has_error">
                                            <input type="text" class="form-control date" placeholder="Apellido Paterno" name="ap_usuario" value="<?php echo $usuario->ap_usuario; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line" id="am_has_error">
                                            <input type="text" class="form-control date" placeholder="Apellido Materno" name="am_usuario" value="<?php echo $usuario->am_usuario; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php
                                            foreach ($roles as $id_rol => $rol) {
                                                echo '
                                                    <input id="rol-'.$id_rol.'" type="checkbox" class="form-control date" name="rol[]" value="'.$id_rol.'" '.(in_array($id_rol, $rol_usuario) ? 'checked' : '' ).'>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group form-float">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php echo form_dropdown(['id'=>'genero_has_error', 'name'=>'genero_usuario', 'class'=>'form-control', 'data-width'=>'100%'], [$usuario->genero_usuario=>$this->constantes->GENEROS[$usuario->genero_usuario]]+$this->constantes->GENEROS); ?>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line" id="usuario_has_error">
                                            <input type="email" class="form-control date" placeholder="usuario@ejemplo.com" name="usuario" value="<?php echo $usuario->email_usuario; ?>">
                                        </div>
                                    </div>
